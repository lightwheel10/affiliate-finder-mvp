...
export const en: Dictionary = {
  ...
  landing: {
    ...
    pricing: {
      ...
      sectionSubtitle: 'All plans include weekly affiliate discovery to keep your pipeline full. Start with a 3-day free trial.',
    ...
    cta: {
      ...
      ctaSecondary: 'Get a Demo',
      trustNote: '3-day free trial • Cancel anytime',
    },
  ...
  onboarding: {
    ...
    step7: {
      ...
      title: 'Start your {days}-day free trial',
      subtitle: "Enter your card details • You won't be charged today",
      returningTitle: 'Confirm your subscription',
      returningSubtitle: 'Enter your card details • You will be charged today',
      selectedPlan: 'Selected Plan',
      perMonth: '/mo',
      billedAnnually: 'Billed annually',
      firstCharge: 'First charge: {days} days from now',
      chargeToday: 'First charge: today',
      ...
      cancelAnytimePaid: 'Cancel anytime. Your plan starts immediately.',
      noChargeToday: 'No charge today',
      secureFooter: 'Your payment is secured by Stripe. We never store your card details.',
      checkingTerms: 'Checking when your billing starts...',
  ...
  dashboard: {
    ...
    brandLocations: {
      ...
      switchBrand: 'Switch the active brand',
      switchLocation: 'Switch the active dashboard location',
      switchLocations: 'Choose dashboard locations',
      allLocations: 'All locations',
      locationsSelected: '{count} locations',
      done: 'Done',
      loadingPortfolio: 'Loading your brands and locations...',
      portfolioUnavailable: 'Brands and locations are unavailable',
      portfolioUnavailableDescription: 'We could not safely load an active location. Retry before continuing.',
      unknownMarket: 'Unknown market',
      pageTitle: 'Brands & Locations',
      pageSubtitle: 'Keep each brand and market separate, including its search topics and competitors.',
      addBrand: 'Add brand',
      addLocation: 'Add location',
      editBrand: 'Edit brand',
      editLocation: 'Edit location',
      createBrandTitle: 'Create a brand',
      createLocationTitle: 'Add a location',
      brandName: 'Brand name',
      brandDomain: 'Website domain',
      brandBio: 'Brand description',
      brandBioPlaceholder: 'Briefly explain what this brand offers and who it serves.',
      brandBioHint: 'Write your own description or generate a factual draft from the website.',
      generateDescription: 'Generate with AI',
      regenerateDescription: 'Generate again',
      generatingDescription: 'Generating...',
      affiliateTypes: 'Affiliate types',
      affiliateTypesHint: 'Choose every channel that fits this brand.',
      country: 'Country',
      language: 'Language',
      topics: 'Topics / keywords',
      competitors: 'Competitors',
      onePerLine: 'One per line, up to 5',
      active: 'Active',
      archived: 'Archived',
      ...
      paidCapacity: {
        ...
        description: 'Add room for more brands or locations without changing your plan.',
        brandCapacity: 'Brand capacity',
        locationCapacity: 'Location capacity',
        usage: '{used} of {total} used',
        brands: 'brands',
        locations: 'locations',
        included: '{count} included with {plan}',
        paidExtra: '{count} paid extra',
        monthlyUnit: '€{price}/month each',
        change: 'Change',
        addCapacity: 'Add capacity',
        manageExtras: 'Manage extras',
        loading: 'Loading capacity...',
        unavailable: 'Extra capacity could not be loaded safely.',
        retry: 'Retry',
        purchaseUnavailable: 'Finish your current plan or payment change before buying more capacity.',
        pendingTitle: 'A capacity payment needs attention',
        pendingDescription: 'Continue the secure payment you already started before making another change.',
        pendingUnavailable: 'A Stripe payment is pending, but it cannot be resumed here. Check your payment method or contact support.',
        resumePayment: 'Continue payment',
        resumingPayment: 'Checking payment...',
        changeBrandTitle: 'Change brand capacity',
        changeLocationTitle: 'Change location capacity',
        currentPaidExtra: 'Current paid extras',
        newPaidExtra: 'New paid extras',
        decreaseQuantity: 'Decrease quantity',
        increaseQuantity: 'Increase quantity',
        totalCapacity: 'Total account capacity',
        estimatedMonthly: 'Estimated add-on total',
        perMonthSuffix: '/ month',
        decreaseWarning: 'If the new limit is smaller than what you use now, you must choose what stays active.',
        reviewPrice: 'Review exact price',
        reviewingPrice: 'Getting Stripe price...',
        priceTitle: 'Confirm your change',
        dueNow: 'Due now',
        monthlyTotal: 'New monthly add-on total',
        proration: 'Proration in today\'s total: {amount}',
        quoteExpiry: 'This exact price is held until {time}.',
        increaseAction: 'Pay & update capacity',
        decreaseAction: 'Confirm reduction',
        ...
        chooseMessage: 'Your new capacity is smaller. Select the brands and locations that should remain active.',
        brandsKept: 'Brands kept',
        locationsKept: 'Locations kept',
        keepBrand: 'Keep brand',
        keepLocation: 'Keep location',
        noActiveLocations: 'This brand has no active locations.',
        archiveNote: 'Everything else will be archived safely. Existing leads and outreach will not be deleted.',
        back: 'Back',
        confirmChoice: 'Review exact price',
        confirmingChoice: 'Checking selection...',
        paymentError: 'The capacity change could not be completed. No extra access was granted.',
        paymentSyncing: 'Your card was confirmed, but Stripe is still finishing the update. Use Continue payment to check again.',
        managePayment: 'Manage payment method',
      },
      noBrands: 'No active brands',
      noBrandsDescription: 'Create a brand, then add at least one location to start searching.',
      noLocations: 'No active locations',
      noLocationsDescription: 'Add a country and language so this brand can search in that market.',
      showArchived: 'Show archived',
      hideArchived: 'Hide archived',
      searchDefaults: 'Search defaults',
      topicCount: 'topics',
      competitorCount: 'competitors',
      autoScanOn: 'Weekly scan included',
      autoScanOff: 'Weekly scan off',
      archiveBrandTitle: 'Archive this brand?',
      archiveBrandMessage: 'Its locations will stop being available for new work. Existing leads and outreach stay safely stored.',
      archiveLocationTitle: 'Archive this location?',
      archiveLocationMessage: 'New searches and future weekly scans will stop for this location. Existing leads and outreach stay safely stored.',
      archiveSafetyNote: 'Nothing is permanently deleted. You can restore it later if your current plan has capacity.',
      errors: {
        descriptionDomainRequired: 'Enter a valid website domain before using AI.',
        descriptionGenerationFailed: 'We could not generate a description. You can still write it manually.',
        generic: 'The request could not be completed. Please try again.',
        planLimit: 'Your plan has reached its active brand or location limit.',
        subscriptionRequired: 'An active or trialing subscription is required to add or restore capacity.',
        activeSearch: 'Wait for the active search to finish before archiving this item.',
        lastContext: 'The account must keep at least one active brand and location.',
        duplicateBrand: 'This brand domain already exists in the account.',
        duplicateLocation: 'This brand already has a location for that market.',
        tooManyValues: 'Use no more than {limit} unique values.',
        refreshFailed: 'The change was saved, but the latest list could not load. Please retry the page.',
      },
    },
    credits: {
    ...
    find: {
      ...
      loading: {
        ...
        // April 28, 2026: i18n migration of polling-search phase strings.
        progress: {
          starting: {
      ...
      modal: {
        ...
        subtitle: 'Add keywords and competitors (up to 5 each) to discover relevant creators',
        keywordsLabel: 'Keywords',
        keywordsPlaceholder: 'Type keyword + Enter...',
        addButton: 'Add',
        websiteLabel: 'Website',
        targetMarket: 'Search location',
        targetMarketHint: 'Every search uses one location. Choose from the same countries and languages available during onboarding.',
        savedLocation: 'Saved location',
        newLocation: 'New location',
        locationRequired: 'Choose a country and language before searching.',
        confirmLocationTitle: 'Add this location?',
        confirmLocationMessage: 'Add {market} to {brand} and use it for this search? Its keywords and competitors will be saved separately.',
        addLocationAndSearch: 'Add location & search',
        addingLocation: 'Adding location...',
        competitorsLabel: 'Competitors',
        competitorsInputLabel: 'Competitors',
        competitorsPlaceholder: 'Enter competitor domain...',
        addCompetitorButton: 'Add',
        noCompetitorsYet: 'No competitors added yet',
        clearAllCompetitors: 'Clear all',
      ...
      bulkActions: {
        ...
        blockDomains: 'Block for account',
        blockLimitReached: 'Block limit reached (10 max)',
        blockDomainDone: 'Domain blocked for this account',
        blockDomainsDone: 'domains blocked for this account',
      },
      newSearchWarning: {
    ...
    settings: {
      ...
      tabs: {
        ...
        brandsLocations: {
          ...
          description: 'Manage each brand and its markets',
        },
        plan: {
          label: 'Plan & Billing',
      ...
      plan: {
        ...
        noPaymentMethod: {
          ...
          activeSubtitle: 'Add a payment method for future purchases or plan changes.',
      ...
      buyCredits: {
        ...
        total: 'Total',
        selectPackToContinue: 'Select a credit pack to continue.',
  ...
  findingAffiliates: {
    ...
    // Elapsed time suffix
    elapsed: 'elapsed',
    errorTitle: 'We could not finish your first search',
    errorMessage: 'Your account and subscription are ready. No duplicate search will be started automatically; you can safely retry now or continue to your dashboard.',
    retry: 'Retry search',
  ...
  pricingModal: {
    ...
    downgradeChoiceTitle: 'Choose what stays active',
    downgradeChoiceMessage: 'The {plan} plan has lower limits. Select the brands and locations you want to keep active.',
    brandsKept: 'Brands kept active',
    locationsKept: 'Locations kept active',
    keepBrand: 'Keep this brand',
    keepLocation: 'Keep this location',
    noActiveLocations: 'This brand has no active locations and cannot be kept.',
    downgradeArchiveNote: 'When the new plan starts, everything not selected will be archived—not deleted. Leads, outreach and search history stay safe.',
    backToPlans: 'Back to plans',
    confirmDowngrade: 'Confirm downgrade',
    confirmingDowngrade: 'Scheduling downgrade…',
    downgradePortfolioError: 'Your brands and locations could not be loaded safely. Nothing was changed.',
    upgradeRestorationComplete: 'Upgrade complete. Restored {brands} brands and {locations} locations.',
    upgradeRestorationNeedsChoice: 'Upgrade complete. Some archived items need your choice in Settings → Brands & Locations.',
  },
};
