...
/**
 * =============================================================================
 * Terms of Service Page — SMOOVER REFRESH (April 25, 2026)
 * =============================================================================
 *
 * History:
 *   Jan  8, 2026 — Original neo-brutalist version.
 *   Jan 10, 2026 — i18n migration (t.legalPages.terms.* / .common.*).
 *   Apr 25, 2026 — Smoover refresh (this version).
 *
 * Shares the same template as the other 3 legal pages (cookies / privacy /
 * security). Full brutalist -> smoover visual mapping is documented in
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[#ffbf23] rounded-2xl mb-6 shadow-yellow-glow-sm">
            <FileText size={32} className="text-[#1A1D21]" strokeWidth={2} />
          </div>
          <h1 className="text-4xl font-display font-bold tracking-tight text-[#0f172a] dark:text-white mb-4">{t.legalPages.terms.title}</h1>
        ...
        <div className="bg-white dark:bg-[#0f0f0f] border border-[#e6ebf1] dark:border-gray-800 rounded-2xl shadow-soft-xl p-8 md:p-12">
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <h2 className="text-xl font-display font-semibold tracking-tight text-[#0f172a] dark:text-white mb-4">{t.legalPages.terms.sections.acceptanceOfTerms}</h2>
            <p className="text-[#425466] dark:text-gray-400 mb-6">
              {t.legalPages.terms.sections.acceptanceOfTermsPlaceholder}
            </p>

            <h2 className="text-xl font-display font-semibold tracking-tight text-[#0f172a] dark:text-white mb-4">{t.legalPages.terms.sections.descriptionOfService}</h2>
            <p className="text-[#425466] dark:text-gray-400 mb-6">
              {t.legalPages.terms.sections.descriptionOfServicePlaceholder}
            </p>

            <h2 className="text-xl font-display font-semibold tracking-tight text-[#0f172a] dark:text-white mb-4">{t.legalPages.terms.sections.userAccounts}</h2>
            <p className="text-[#425466] dark:text-gray-400 mb-6">
              {t.legalPages.terms.sections.userAccountsPlaceholder}
            </p>

            <h2 className="text-xl font-display font-semibold tracking-tight text-[#0f172a] dark:text-white mb-4">{t.legalPages.terms.sections.paymentAndBilling}</h2>
            <p className="text-[#425466] dark:text-gray-400 mb-6">
              {t.legalPages.terms.sections.paymentAndBillingPlaceholder}
            </p>

            <h2 className="text-xl font-display font-semibold tracking-tight text-[#0f172a] dark:text-white mb-4">{t.legalPages.terms.sections.acceptableUse}</h2>
            <p className="text-[#425466] dark:text-gray-400 mb-6">
              {t.legalPages.terms.sections.acceptableUsePlaceholder}
            </p>

            <h2 className="text-xl font-display font-semibold tracking-tight text-[#0f172a] dark:text-white mb-4">{t.legalPages.terms.sections.intellectualProperty}</h2>
            <p className="text-[#425466] dark:text-gray-400 mb-6">
              {t.legalPages.terms.sections.intellectualPropertyPlaceholder}
            </p>

            <h2 className="text-xl font-display font-semibold tracking-tight text-[#0f172a] dark:text-white mb-4">{t.legalPages.terms.sections.limitationOfLiability}</h2>
            <p className="text-[#425466] dark:text-gray-400 mb-6">
