...
export interface Dictionary {
  ...
  dashboard: {
    ...
    brandLocations: {
      ...
      paidCapacity: {
        ...
        changeBrandTitle: string;
        changeLocationTitle: string;
        currentPaidExtra: string;
        newPaidExtra: string;
        ...
        processing: string;
        successTitle: string;
        increaseSuccess: string;
        decreaseSuccess: string;
  ...
  scanCountdown: {
    ...
    settingsTitle: string;        // Settings toggle card title
    settingsDescription: string;  // Settings toggle card description
  };
