...
export const de: Dictionary = {
  ...
  landing: {
    ...
    pricing: {
      ...
      sectionSubtitle: 'Alle Pläne beinhalten wöchentliche Affiliate-Entdeckung, um deine Pipeline voll zu halten. Starte mit einer 3-tägigen kostenlosen Testversion.',
      mostPopular: 'Am beliebtesten',
      perMonth: '/Monat',
      pro: {
        name: 'Pro',
        description: 'Für wachsende E-Commerce- und SaaS-Marken, die ihren Affiliate-Kanal skalieren möchten',
        price: `${PLAN_CATALOG.pro.pricing.monthlyEur} €`,
        cta: '3-Tage-Testversion starten',
        features: [
          '75 neue Affiliates / Monat finden',
          '30 verifizierte E-Mail-Credits / Monat',
          '30 hyper-personalisierte Mail-Credits',
          `${PLAN_CATALOG.pro.entitlements.maxBrands} Markenprojekt`,
          'Suchfilter inklusive',
          'Self-Service (kein Support)',
          'CSV-Export',
        ],
      },
      growth: {
        name: 'Business Class',
        description: 'Für wachsende Marken, die mehr Reichweite, mehr Marken und E-Mail-Support benötigen',
        price: `${PLAN_CATALOG.business.pricing.monthlyEur} €`,
        cta: '3-Tage-Testversion starten',
        features: [
          'Alles in Pro +',
          'Unbegrenzt Affiliates finden',
          '150 verifizierte E-Mail-Credits / Monat',
          '150 hyper-personalisierte Mail-Credits',
          `${PLAN_CATALOG.business.entitlements.maxBrands} Markenprojekte`,
          'E-Mail-Support',
        ],
      },
    ...
    cta: {
      ...
      ctaPrimary: 'Deine 3-Tage-Testversion starten',
      ctaSecondary: 'Demo anfordern',
      trustNote: '3 Tage kostenlos testen • Jederzeit kündbar',
    },
  ...
  onboarding: {
    ...
    step5: {
      ...
      // March 9, 2026: Updated plans to match new pricing
      plans: {
        pro: {
          name: 'Pro',
          description: 'Für wachsende E-Commerce- und SaaS-Marken, die ihren Affiliate-Kanal skalieren möchten.',
    ...
    step7: {
      ...
      title: 'Starte deine kostenlose Testversion für {days} Tage',
      subtitle: 'Gib deine Kartendaten ein • Heute wird nichts berechnet',
      returningTitle: 'Bestätige dein Abonnement',
      returningSubtitle: 'Gib deine Kartendaten ein • Die Abbuchung erfolgt heute',
      selectedPlan: 'Ausgewählter Plan',
      perMonth: '/Monat',
      billedAnnually: 'Jährlich abgerechnet',
      firstCharge: 'Erste Abbuchung: in {days} Tagen',
      chargeToday: 'Erste Abbuchung: heute',
      ...
      cancelAnytimePaid: 'Jederzeit kündbar. Dein Plan startet sofort.',
      ...
      checkingTerms: 'Der Beginn deiner Abrechnung wird geprüft...',
  ...
  dashboard: {
    ...
    brandLocations: {
      ...
      activeLocations: 'Standorte',
      switchBrand: 'Aktive Marke wechseln',
      switchLocation: 'Aktiven Dashboard-Standort wechseln',
      switchLocations: 'Dashboard-Standorte auswählen',
      allLocations: 'Alle Standorte',
      locationsSelected: '{count} Standorte',
      done: 'Fertig',
      loadingPortfolio: 'Marken und Standorte werden geladen...',
      portfolioUnavailable: 'Marken und Standorte sind nicht verfügbar',
      portfolioUnavailableDescription: 'Es konnte kein aktiver Standort sicher geladen werden. Bitte versuchen Sie es erneut.',
      unknownMarket: 'Unbekannter Markt',
      pageTitle: 'Marken & Standorte',
      pageSubtitle: 'Verwalten Sie jede Marke und jeden Markt getrennt, einschließlich Suchthemen und Wettbewerbern.',
      ...
      createLocationTitle: 'Standort hinzufügen',
      brandName: 'Markenname',
      brandDomain: 'Website-Domain',
      brandBio: 'Markenbeschreibung',
      brandBioPlaceholder: 'Beschreiben Sie kurz, was diese Marke anbietet und für wen.',
      brandBioHint: 'Schreiben Sie selbst eine Beschreibung oder erstellen Sie einen sachlichen Entwurf von der Website.',
      generateDescription: 'Mit KI erstellen',
      regenerateDescription: 'Neu erstellen',
      generatingDescription: 'Wird erstellt...',
      affiliateTypes: 'Affiliate-Typen',
      affiliateTypesHint: 'Wählen Sie alle passenden Kanäle für diese Marke aus.',
      country: 'Land',
      language: 'Sprache',
      topics: 'Themen / Keywords',
      competitors: 'Wettbewerber',
      onePerLine: 'Einer pro Zeile, maximal 5',
      active: 'Aktiv',
      archived: 'Archiviert',
      ...
      brandsUsed: 'Marken verwendet',
      locationsUsed: 'Standorte verwendet',
      unlimited: 'Unbegrenzt',
      planCapacity: 'Tarifkapazität',
      paidCapacity: {
        title: 'Zusätzliche Kapazität',
        description: 'Fügen Sie Platz für weitere Marken oder Standorte hinzu, ohne den Tarif zu wechseln.',
        brandCapacity: 'Markenkapazität',
        locationCapacity: 'Standortkapazität',
        usage: '{used} von {total} verwendet',
        brands: 'Marken',
        locations: 'Standorte',
        included: '{count} in {plan} enthalten',
        paidExtra: '{count} kostenpflichtig zusätzlich',
        monthlyUnit: '€{price}/Monat pro Einheit',
        change: 'Ändern',
        addCapacity: 'Kapazität hinzufügen',
        manageExtras: 'Extras verwalten',
        loading: 'Kapazität wird geladen...',
        unavailable: 'Die zusätzliche Kapazität konnte nicht sicher geladen werden.',
        retry: 'Erneut versuchen',
        purchaseUnavailable: 'Schließen Sie zuerst die aktuelle Tarif- oder Zahlungsänderung ab.',
        pendingTitle: 'Eine Kapazitätszahlung erfordert Ihre Aufmerksamkeit',
        pendingDescription: 'Setzen Sie die bereits gestartete sichere Zahlung fort, bevor Sie eine weitere Änderung vornehmen.',
        pendingUnavailable: 'Eine Stripe-Zahlung ist offen, kann hier aber nicht fortgesetzt werden. Prüfen Sie die Zahlungsmethode oder kontaktieren Sie den Support.',
        resumePayment: 'Zahlung fortsetzen',
        resumingPayment: 'Zahlung wird geprüft...',
        changeBrandTitle: 'Markenkapazität ändern',
        changeLocationTitle: 'Standortkapazität ändern',
        currentPaidExtra: 'Aktuelle bezahlte Extras',
        newPaidExtra: 'Neue bezahlte Extras',
        decreaseQuantity: 'Menge verringern',
        increaseQuantity: 'Menge erhöhen',
        totalCapacity: 'Gesamtkapazität des Kontos',
        estimatedMonthly: 'Geschätzte Add-on-Summe',
        perMonthSuffix: '/ Monat',
        decreaseWarning: 'Wenn das neue Limit kleiner als die aktuelle Nutzung ist, müssen Sie auswählen, was aktiv bleibt.',
        reviewPrice: 'Genauen Preis prüfen',
        reviewingPrice: 'Stripe-Preis wird geladen...',
        priceTitle: 'Änderung bestätigen',
        dueNow: 'Heute fällig',
        monthlyTotal: 'Neue monatliche Add-on-Summe',
        proration: 'Anteil im heutigen Gesamtbetrag: {amount}',
        quoteExpiry: 'Dieser genaue Preis gilt bis {time}.',
        increaseAction: 'Bezahlen und Kapazität ändern',
        decreaseAction: 'Reduzierung bestätigen',
        ...
        chooseMessage: 'Ihre neue Kapazität ist kleiner. Wählen Sie die Marken und Standorte aus, die aktiv bleiben sollen.',
        brandsKept: 'Behaltene Marken',
        locationsKept: 'Behaltene Standorte',
        keepBrand: 'Marke behalten',
        keepLocation: 'Standort behalten',
        noActiveLocations: 'Diese Marke hat keine aktiven Standorte.',
        archiveNote: 'Alles andere wird sicher archiviert. Bestehende Leads und Kontaktaufnahmen werden nicht gelöscht.',
        back: 'Zurück',
        confirmChoice: 'Genauen Preis prüfen',
        confirmingChoice: 'Auswahl wird geprüft...',
        paymentError: 'Die Kapazitätsänderung konnte nicht abgeschlossen werden. Es wurde kein zusätzlicher Zugriff gewährt.',
        paymentSyncing: 'Ihre Karte wurde bestätigt, aber Stripe schließt die Aktualisierung noch ab. Prüfen Sie erneut über Zahlung fortsetzen.',
        managePayment: 'Zahlungsmethode verwalten',
      },
      noBrands: 'Keine aktiven Marken',
      noBrandsDescription: 'Erstellen Sie eine Marke und fügen Sie anschließend mindestens einen Standort hinzu.',
      noLocations: 'Keine aktiven Standorte',
      noLocationsDescription: 'Fügen Sie Land und Sprache hinzu, damit diese Marke in diesem Markt suchen kann.',
      showArchived: 'Archivierte anzeigen',
      hideArchived: 'Archivierte ausblenden',
      searchDefaults: 'Suchvorgaben',
      topicCount: 'Themen',
      competitorCount: 'Wettbewerber',
      autoScanOn: 'Wöchentlicher Scan enthalten',
      autoScanOff: 'Wöchentlicher Scan aus',
      archiveBrandTitle: 'Diese Marke archivieren?',
      archiveBrandMessage: 'Ihre Standorte stehen für neue Aufgaben nicht mehr zur Verfügung. Bestehende Leads und Kontaktaufnahmen bleiben sicher gespeichert.',
      archiveLocationTitle: 'Diesen Standort archivieren?',
      archiveLocationMessage: 'Neue Suchen und zukünftige wöchentliche Scans werden für diesen Standort beendet. Bestehende Daten bleiben gespeichert.',
      archiveSafetyNote: 'Nichts wird dauerhaft gelöscht. Eine Wiederherstellung ist möglich, wenn Ihr aktueller Tarif Kapazität hat.',
      errors: {
        descriptionDomainRequired: 'Geben Sie zuerst eine gültige Website-Domain ein.',
        descriptionGenerationFailed: 'Die Beschreibung konnte nicht erstellt werden. Sie können sie weiterhin selbst eingeben.',
        generic: 'Die Anfrage konnte nicht abgeschlossen werden. Bitte versuchen Sie es erneut.',
        planLimit: 'Das Limit für aktive Marken oder Standorte Ihres Tarifs ist erreicht.',
        subscriptionRequired: 'Zum Hinzufügen oder Wiederherstellen ist ein aktives oder testendes Abonnement erforderlich.',
        activeSearch: 'Warten Sie, bis die aktive Suche abgeschlossen ist, bevor Sie dieses Element archivieren.',
        lastContext: 'Das Konto muss mindestens eine aktive Marke und einen aktiven Standort behalten.',
        duplicateBrand: 'Diese Marken-Domain existiert bereits im Konto.',
        duplicateLocation: 'Für diese Marke existiert bereits ein Standort in diesem Markt.',
        tooManyValues: 'Verwenden Sie höchstens {limit} eindeutige Werte.',
        refreshFailed: 'Die Änderung wurde gespeichert, aber die aktuelle Liste konnte nicht geladen werden. Bitte laden Sie die Seite erneut.',
      },
    },
    credits: {
    ...
    table: {
      ...
      emailFilterShowAll: 'Alle Affiliates anzeigen',
      emailFilterShowWithEmail: 'Nur Affiliates mit E-Mail anzeigen',
    },
    // =========================================================================
    ...
    find: {
      ...
      modal: {
        ...
        subtitle: 'Füge Keywords und Wettbewerber hinzu (je bis zu 5), um relevante Creator zu entdecken',
        keywordsLabel: 'Keywords',
        keywordsPlaceholder: 'Keyword eingeben + Enter...',
        addButton: 'Hinzufügen',
        websiteLabel: 'Website',
        targetMarket: 'Suchstandort',
        targetMarketHint: 'Jede Suche verwendet einen Standort. Wähle aus denselben Ländern und Sprachen wie beim Onboarding.',
        savedLocation: 'Gespeicherter Standort',
        newLocation: 'Neuer Standort',
        locationRequired: 'Wähle vor der Suche ein Land und eine Sprache aus.',
        confirmLocationTitle: 'Diesen Standort hinzufügen?',
        confirmLocationMessage: '{market} zu {brand} hinzufügen und für diese Suche verwenden? Keywords und Wettbewerber werden separat gespeichert.',
        addLocationAndSearch: 'Standort hinzufügen & suchen',
        addingLocation: 'Standort wird hinzugefügt...',
        competitorsLabel: 'Wettbewerber',
        competitorsInputLabel: 'Wettbewerber',
        competitorsPlaceholder: 'Wettbewerber-Domain eingeben...',
        addCompetitorButton: 'Hinzufügen',
        noCompetitorsYet: 'Noch keine Wettbewerber hinzugefügt',
        clearAllCompetitors: 'Alle löschen',
      ...
      bulkActions: {
        ...
        blockDomains: 'Für Konto sperren',
        blockLimitReached: 'Sperrlimit erreicht (max. 10)',
        blockDomainDone: 'Domain für dieses Konto gesperrt',
        blockDomainsDone: 'Domains für dieses Konto gesperrt',
      },
      newSearchWarning: {
    ...
    settings: {
      ...
      tabs: {
        ...
        brandsLocations: {
          label: 'Marken & Standorte',
          description: 'Verwalte jede Marke und ihre Märkte',
        },
        plan: {
      ...
      plan: {
        ...
        noPaymentMethod: {
          ...
          activeSubtitle: 'Füge eine Zahlungsmethode für zukünftige Käufe oder Tarifänderungen hinzu.',
      ...
      buyCredits: {
        ...
        total: 'Gesamt',
        selectPackToContinue: 'Wähle ein Credit-Paket aus, um fortzufahren.',
        continueToCheckout: 'Weiter zur sicheren Kasse',
        buyNow: 'Jetzt kaufen',
        benefits: {
  ...
  findingAffiliates: {
    ...
    // Elapsed time suffix
    elapsed: 'vergangen',
    errorTitle: 'Deine erste Suche konnte nicht abgeschlossen werden',
    errorMessage: 'Dein Konto und Abonnement sind bereit. Es wird nicht automatisch eine doppelte Suche gestartet. Du kannst die Suche jetzt sicher erneut versuchen oder zum Dashboard wechseln.',
    retry: 'Suche erneut versuchen',
  ...
  pricingModal: {
    ...
    downgradeChoiceTitle: 'Wähle aus, was aktiv bleibt',
    downgradeChoiceMessage: 'Der {plan}-Plan hat niedrigere Limits. Wähle die Marken und Standorte aus, die aktiv bleiben sollen.',
    brandsKept: 'Aktive Marken',
    locationsKept: 'Aktive Standorte',
    keepBrand: 'Diese Marke behalten',
    keepLocation: 'Diesen Standort behalten',
    noActiveLocations: 'Diese Marke hat keine aktiven Standorte und kann nicht behalten werden.',
    downgradeArchiveNote: 'Wenn der neue Plan beginnt, wird alles, was nicht ausgewählt ist, archiviert – nicht gelöscht. Leads, Outreach und Suchverlauf bleiben erhalten.',
    backToPlans: 'Zurück zu den Plänen',
    confirmDowngrade: 'Downgrade bestätigen',
    confirmingDowngrade: 'Downgrade wird geplant…',
    downgradePortfolioError: 'Deine Marken und Standorte konnten nicht sicher geladen werden. Es wurde nichts geändert.',
    upgradeRestorationComplete: 'Upgrade abgeschlossen. {brands} Marken und {locations} Standorte wurden wiederhergestellt.',
    upgradeRestorationNeedsChoice: 'Upgrade abgeschlossen. Für einige archivierte Einträge ist deine Auswahl unter Einstellungen → Marken & Standorte erforderlich.',
  },
};
