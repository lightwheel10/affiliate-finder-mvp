...
export default function FindNewPage() {
  ...
  const searchCountryOptions = useMemo<readonly SearchMarketPickerOption[]>(
  ...
  const searchLanguageOptions = useMemo<readonly SearchMarketPickerOption[]>(
      ...
      */}
      ...
      >
        <div className="space-y-4">
          ...
          <section className="relative z-20 rounded-2xl border border-[#e6ebf1] bg-[#f8fafc] p-2.5 shadow-soft-sm dark:border-gray-800 dark:bg-white/[0.025]">
            ...
            {brandLocationsEnabled && (
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                <SearchMarketPicker
                  id="affiliate-country-picker"
                  label={t.dashboard.brandLocations.country}
                  value={searchCountryCode}
                  options={searchCountryOptions}
                  onChange={(countryCode) => selectSearchMarket(countryCode, searchLanguageCode)}
                ...
                />
                <SearchMarketPicker
                  id="affiliate-language-picker"
                  label={t.dashboard.brandLocations.language}
                  value={searchLanguageCode}
                  options={searchLanguageOptions}
                  onChange={(languageCode) => selectSearchMarket(searchCountryCode, languageCode)}
                  searchPlaceholder={t.onboarding.common.search}
                  noResultsText={t.onboarding.common.noResults}
                  disabled={loading || isCreatingSearchLocation}
                  variant="language"
